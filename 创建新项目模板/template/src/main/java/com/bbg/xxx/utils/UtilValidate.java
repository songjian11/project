 ...
 * <br/> 概要:
 * <br/>
 * <br/> 这是一套用于验证输入的方法。功能验证:
 * <br/>    - 美国和国际电话/传真号码
 * <br/>    - 美国邮政编码（5或9位邮政编码）
 * <br/>    - 美国邮政编码（2个字母的缩写名称的状态）
 * <br/>    - 美国社会安全号（简称SSNS）
 * <br/>    - 电子邮件地址
 * <br/>    - 日期（输入年，月，日和组合的有效日期）
 * <br/>    - 信用卡号码
 * <br/>
 * <br/> 支撑的实用功能验证:
 * <br/>    - 字符是字母或数字
 * <br/>    - 字符串是正数， 负数, 正整数, 或非负整数
 * <br/>    - 字符串是浮点数
 * <br/>    - 字符串是字母，数字，或空白
 * <br/>    - 在指定的字符串范围内包含一个整数
 * <br/>
 * <br/> 其他实用功能:
 * <br/>    - 删除从一个字符串中的字符是/不是一个“bag”所选字符
 * <br/>       - strip whitespace/leading whitespace from a string
 * <br/>
 * <br/> ==============================================================================
 * <br/> 注：此代码是改编自网页浏览器的JavaScript表单验证代码.
 * <br/> ==============================================================================
 */
public class UtilValidate {
    ...
    public static boolean isEmpty(Object o) {
        ...
        if (o instanceof Collection) return ((Collection<? extends Object>) o).size() == 0;
        if (o instanceof Map) return ((Map<? extends Object, ? extends Object>) o).size() == 0;
